    ...
    <>
      ...
      <div>
        <header className="navbar navbar-top navbar-expand-lg navbar-fixed">
          <div className="container">
            <a href={assetPath("/")} className="nav-link active">
              <span className="nav-link-name title-top-black">Shehab.</span>
            </a>
            <a className="navbar-toggle" href="#navbar-mobile-style-2" data-fancybox data-base-class="fancybox-navbar" data-keyboard="false" data-auto-focus="false" data-touch="false" data-close-existing="true" data-small-btn="false" data-toolbar="false">
              <span></span>
              <span></span>
              <span></span>
            </a>
            <ul className="nav navbar-nav">
              <li className="nav-item navbar-dropdown navbar-dropdown-mega active">
                <a href={assetPath("/")} className="nav-link">
              ...
              <li className="nav-item navbar-dropdown">
                <a href={assetPath("/dist/resume.pdf")} className="nav-link">
              ...
              <div className="col-12 col-md-7 col-lg-5 col-xl-4">
                <div className="navbar-body">
                  <ul className="nav navbar-nav navbar-nav-collapse">
                    ...
                    <li className="nav-item navbar-collapse">
                      <a href={assetPath("/dist/resume.pdf")} className="nav-link collapsed" aria-expanded="false" aria-controls="navbarCollapsePages">
                        <span className="nav-link-name">resume</span>
                        <svg className="collapse-icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1 11L6 6L1 1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                ...
                <div className="navbar-footer">
                  <div className="mb-60">
                    ...
                    <ul className="list-group borderless font-size-17">
                      <li className="list-group-item">Email: <a className="mailphone-item-blacktext" href="mailto:hey@shehab.io">hey@shehab.io</a></li>
                      <li className="list-group-item">Phone: <a className="mailphone-item-blacktext" href="tel: 2019127328">(201)-912-7328</a></li>
                    </ul>
                  </div>
                  <div className="mb-60">
                    <ul className="list-group borderless font-size-17">
                      <li className="list-group-item">take a sip of water!</li>
                    </ul>
                  </div>
                  <ul className="nav nav-gap-sm navbar-nav nav-social align-items-center mt-n10">
                    <li className="nav-item">
                      <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/shehabaldenibrahim/" className="nav-link">
                    ...
                    <li className="nav-item">
                      <a target="_blank" rel="noopener noreferrer" href="https://github.com/ShehabIbrahim" className="nav-link">
        ...
        <div className="content-wrap">
          <div className="container pt-160 mt-10 shape-parent">
            <div className="row gh-1 gv-1">
              <div className="col-12 show-on-scroll" data-show-duration="500" data-show-distance="20">
                <a href={assetPath("/dist/assets/images/single-portfolio/Axios Banner.jpg")} className="gallery-item gallery-item-sm" data-fancybox="gallery-1" data-animation-effect="fade">
                  <img src={assetPath("/dist/assets/images/single-portfolio/Axios Banner.jpg")} alt="Axios project banner showcasing AI-powered news delivery platform design" />
                </a>
              </div>
            </div>
          </div>
          <div className="content-wrap">
            <div className="container">
              <div className="row justify-content-center gh-1 mb-100 tb-100">
                <div className="col-lg-8 post-content">
                  <p className="note">Note: I served as Lead Product Designer for all work shown on this page.</p>
                  <p>At Axios, I led the design direction of many parts of the digital news company, leveraging my expertise as a product designer and developer to enhance both user-facing platforms and internal tools.</p>
                  <p> My work spanned the entire product ecosystem - I launched a multi-brand design system, consolidated a set of fragmented internal tools to create a cohesive operating system, and created zero-to-one experiences balancing cutting-edge technology with journalistic integrity and user privacy, elevating Axios's position as a leader in modern digital news delivery.</p>
                  <p>If you're interested in learning more - I can go deeper on these project in an interview!</p>
                </div>
              </div>
            </div>
          </div>
